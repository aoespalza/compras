...
class PurchaseOrderUseCases {
    ...
    async createPurchaseOrder(data, createdById) {
        return purchaseOrderRepository_1.purchaseOrderRepository.create(data, createdById);
    }
    ...
    async updateStatus(id, status, changedById, notes) {
        ...
        return purchaseOrderRepository_1.purchaseOrderRepository.updateStatus(id, status, changedById, notes);
    }
