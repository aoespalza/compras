...
router.get('/', auth_1.authenticate, getAll);
router.get('/:id', auth_1.authenticate, getById);
router.post('/', auth_1.authenticate, (0, auth_1.authorize)('ADMIN', 'PURCHASE_MANAGER', 'PURCHASE_AGENT'), create);
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)('ADMIN', 'PURCHASE_MANAGER', 'PURCHASE_AGENT'), update);
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)('ADMIN', 'PURCHASE_MANAGER'), deleteContract);
router.patch('/:id/status', auth_1.authenticate, (0, auth_1.authorize)('ADMIN', 'PURCHASE_MANAGER'), updateStatus);
exports.default = {
    getAll,
    getById,
    create,
